...
export class GameView extends GameContainer {
    ...
    protected createDebugPanel(): void {
        if (this.config.debug) {
            ...
            this.debugGraphics.fillRect(this.dimensions.x, this.dimensions.y, this.dimensions.width, this.dimensions.height);
            this.debugGraphics.strokeLineShape(new Phaser.Geom.Line(this.dimensions.x, this.dimensions.y + this.dimensions.height * 0.5, this.dimensions.x + this.dimensions.width, this.dimensions.y + this.dimensions.height * 0.5));
            this.debugGraphics.strokeLineShape(new Phaser.Geom.Line(this.dimensions.x + this.dimensions.width * 0.5, this.dimensions.y, this.dimensions.x + this.dimensions.width * 0.5, this.dimensions.y + this.dimensions.height));
